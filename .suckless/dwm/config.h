...
static char *fonts[]          = { "monospace:size=9", "JoyPixels:pixelsize=11:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_minus,	spawn,		SHCMD("amixer -q sset Master 5dB-; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("amixer -q sset Master 15dB-; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("amixer -q sset Master 5dB+; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("amixer -q sset Master 15dB+; kill -44 $(pidof dwmblocks)") },
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -q sset Master 3dB+; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -q sset Master 3dB-; kill -44 $(pidof dwmblocks)") },
